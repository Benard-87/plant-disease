"""
Script to clean up nested folders and start lightweight training
Runs immediately without waiting for TensorFlow installation
"""
...
def cleanup_and_train():
    ...
    print("🚀 Step 2: Starting lightweight training (Keras)...")
    print("=" * 60)
    print("Training will start now. You can monitor progress in VS Code terminal.")
    print()
    
    # Run training using lightweight script
    try:
        subprocess.run([
            sys.executable, 
            "train_model_lightweight.py",
